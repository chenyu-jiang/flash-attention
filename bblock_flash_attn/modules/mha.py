...
from bblock_flash_attn.utils.distributed import get_dim_for_local_rank
...
try:
    from bblock_flash_attn.ops.fused_dense import ColumnParallelLinear, FusedDense, RowParallelLinear
except ImportError:
    FusedDense, ColumnParallelLinear, RowParallelLinear = None, None, None

try:
    from bblock_flash_attn.layers.rotary import RotaryEmbedding
except ImportError:
