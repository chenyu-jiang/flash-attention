...
if not SKIP_CUDA_BUILD and not IS_ROCM:
    ...
    check_if_cuda_home_none("dcp_flash_attn")
    ...
    ext_modules.append(
        CUDAExtension(
            ...
            sources=[
                ...
                "csrc/flash_attn/src/flash_bwd_hdim32_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim32_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim32_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim32_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim32_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim64_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim64_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim64_fp16_2ranges_sm80.cu",
                ...
                "csrc/flash_attn/src/flash_bwd_hdim96_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim96_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim96_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim96_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim96_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim128_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim128_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim128_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim128_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim128_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim128_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim160_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim160_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim160_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim160_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim160_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim160_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim192_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim192_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim192_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim192_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim192_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim192_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim256_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim256_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim256_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim256_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim256_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_bwd_hdim256_bf16_2ranges_sm80.cu",
                ...
                "csrc/flash_attn/src/flash_fwd_split_hdim32_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim32_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim32_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim32_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim32_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim64_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim64_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim64_fp16_2ranges_sm80.cu",
                ...
                "csrc/flash_attn/src/flash_fwd_split_hdim96_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim96_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim96_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim96_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim96_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim128_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim128_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim128_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim128_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim128_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim128_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim160_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim160_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim160_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim160_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim160_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim160_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim192_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim192_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim192_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim192_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim192_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim192_bf16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim256_fp16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim256_fp16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim256_fp16_2ranges_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim256_bf16_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim256_bf16_range_sm80.cu",
                "csrc/flash_attn/src/flash_fwd_split_hdim256_bf16_2ranges_sm80.cu",
    ...
    check_if_rocm_home_none("dcp_flash_attn")
...
def get_package_version():
    with open(Path(this_dir) / "dcp_flash_attn" / "__init__.py", "r") as f:
