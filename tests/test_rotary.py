...
from dcp_flash_attn.layers.rotary import apply_rotary_emb, apply_rotary_emb_torch
from dcp_flash_attn.layers.rotary import apply_rotary_emb_qkv_, apply_rotary_emb_kv_
...
def test_compilation_count():
    ...
    from dcp_flash_attn.ops.triton.rotary import rotary_kernel
    compilation_count = 0
