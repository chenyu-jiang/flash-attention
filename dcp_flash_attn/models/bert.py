...
from dcp_flash_attn.bert_padding import (
    index_first_axis,
...
from dcp_flash_attn.modules.embedding import BertEmbeddings
...
try:
    from dcp_flash_attn.ops.fused_dense import FusedDense
except ImportError:
    FusedDense = None
...
try:
    from dcp_flash_attn.losses.cross_entropy import CrossEntropyLoss
except ImportError:
